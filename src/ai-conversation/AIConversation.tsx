      ...
      >
        {isEmpty ? (
          <div className="ai-conv__empty">
            ...
            <p className="ai-conv__empty-title">Start a conversation with AI</p>
            <p className="ai-conv__empty-hint">
              Ask for a cut, a caption or a resize — your messages appear here.
            </p>
          </div>
        ) : (
